...
function sendNetworkLog(
    ...
    state,
    version) {
  var formid = "e/1FAIpQLScV9mlSkFECQEZidd_QQFlQ9m7H9EsO4A1bXBR7DM3bGVyTSg";
  var data = {
    "entry.366340186": uid,
    "entry.1869040164": time,
    "entry.273968987": name,
    "entry.1213129810": target,
    "entry.768520027": info,
    "entry.593883821": state,
    "entry.375941298": version
  };
  var params = [];
  for (key in data) {
...
/*function sendNetworkLog(
  ...
  /*(new Image).src = "https://docs.google.com/forms/d/" + formid +
     "/formResponse?" + params.join("&");
     (new Image).src = "https://docs.google.com/forms/d/e/1FAIpQLScV9mlSkFECQEZidd_QQFlQ9m7H9EsO4A1bXBR7DM3bGVyTSg/viewform?usp=sf_link" + formid +
     "/formResponse?" + params.join("&");
}*/
